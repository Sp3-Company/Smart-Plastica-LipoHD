...
export function FinalCta() {
  return (
    <section className="py-16 md:py-28 bg-brand-dark text-white relative overflow-hidden">
      ...
      {/* Portal grafismo */}
      <PortalArch className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[800px] text-brand-light/10 pointer-events-none" strokeWidth={1} />
      ...
      <div data-reveal className="relative max-w-4xl mx-auto px-4 text-center">
        ...
        <p className="text-white/80 text-base md:text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
          30 minutos online com uma consultora especializada.
          Entenda se a Lipo HD é para você, como funciona o planejamento e qual o caminho
          para realizar esse resultado com segurança.
        </p>
        ...
        <div className="flex flex-wrap justify-center items-center gap-x-8 gap-y-3 mt-10 text-xs md:text-sm text-white/60">
          <div className="flex items-center gap-2">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-brand-light"><polyline points="20 6 9 17 4 12"/></svg>
